...
module mom6_vert_visc_serial
    ...
    public :: vert_visc_remnant, vert_visc_coef_apply
    public :: vert_visc_CS
...
contains
    ...
    !> Combined vertical viscosity: compute coefficients, remnant, and apply in one call.
    !! This matches the interface used by MPI drivers.
...
end module mom6_vert_visc_serial
