!> Vertical viscosity submodule — IJK loop ordering
!!
!! Loop nest: do concurrent(i, j) with k innermost (sequential).
!! This is the reversed do concurrent order compared to JIK.
...
!!
submodule (mom6_vert_visc) mom6_vert_visc_ijk
    implicit none
...
end submodule mom6_vert_visc_ijk
