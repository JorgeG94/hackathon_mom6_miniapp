!> Vertical viscosity submodule — KJI loop ordering
!!
!! Loop nest: k outermost (sequential), do concurrent(j, i) at each k-level.
!! This is a level-wise parallelism ordering — each k-level is a separate
!! 2D parallel sweep over all (j, i) points.
!!
...
!!
submodule (mom6_vert_visc) mom6_vert_visc_kji
    implicit none
...
end submodule mom6_vert_visc_kji
