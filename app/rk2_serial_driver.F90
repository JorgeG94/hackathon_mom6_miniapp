...
program rk2_serial_driver
    ...
    use mom6_coriolis_serial, only: coriolis_CS, coriolis_init, CorAdCalc, coriolis_end, &
                             SADOURNY75_ENERGY
    use mom6_barotropic_serial, only: barotropic_CS, barotropic_init, btstep, barotropic_end
    use mom6_vert_visc_serial, only: vert_visc_CS, vert_visc_init, vert_visc_coef, &
    ...
    print '(A)', '=================================================='
    print '(A)', 'MOM6 Split RK2 Serial Driver'
    print '(A)', '=================================================='
